  ...
  return (
    <>
      <div
        ...
        style={{ backgroundColor: '#cb6ce6', zoom: '0.85' }}
      >
        ...
        <div className="flex-1 flex flex-col pt-16 md:pt-12 pb-safe overflow-hidden">
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-6">
                ...
                <div className="flex justify-evenly gap-4 mb-6 p-4 bg-purple-50 dark:bg-gray-800 rounded-2xl max-w-md mx-auto">
                  <div className="text-center flex-1">
                    <div
                      className={`text-xl font-bold ${highContrast ? 'text-hc-text' : 'text-gray-900 dark:text-gray-200'}`}
                    >
                  ...
                  <div className="text-center flex-1">
                    ...
                    <div className="text-xs text-gray-600 dark:text-gray-400 mt-1">Attempts</div>
                  </div>
                </div>
                          ...
                          return (
                            ...
                            >
                              {Array.from({ length: wordLength }).map((_, letterIndexInWord) => {
                                ...
                                ${showIncorrectMessage ? 'animate-shake' : ''}
                              `}
          ...
          <div
            className="fixed bottom-0 left-0 right-0 pb-safe pt-3"
