...
export default function CrypticGameScreen({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-purple-200 to-purple-300 dark:from-gray-900 dark:to-gray-800">
      {/* Header with icons - similar to main game */}
      <div className="max-w-4xl w-full mx-auto p-4 pt-6 pb-2">
