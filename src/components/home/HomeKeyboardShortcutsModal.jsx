...
import { HOME_KEYBOARD_SHORTCUTS } from '@/hooks/useHomeKeyboard';

/**
 * HomeKeyboardShortcutsModal - Overlay showing keyboard shortcuts for the home screen.
 * Triggered by pressing ? on the home / welcome screen.
 */
export function HomeKeyboardShortcutsModal({ isOpen, onClose }) {
        ...
        >
          ...
          >
            ...
            <div className="px-5 pb-4 space-y-3">
              {HOME_KEYBOARD_SHORTCUTS.map((category) => (
...
export default HomeKeyboardShortcutsModal;
