    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      ...
      >
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200">Your Statistics</h2>
          <button
            onClick={onClose}
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            <div className="text-3xl font-bold text-gray-800 dark:text-gray-200">{winRate}%</div>
          ...
          >
            ...
            <div className="text-sm text-gray-600 dark:text-gray-400 mt-1">Max Streak</div>
          </div>
        </div>
