...
import { TANDEM_KEYBOARD_SHORTCUTS } from '@/hooks/useTandemKeyboard';

/**
 * TandemKeyboardShortcutsModal - Overlay showing keyboard shortcuts for Daily Tandem.
 * Triggered by pressing ? during gameplay.
 */
export function TandemKeyboardShortcutsModal({ isOpen, onClose }) {
        ...
        >
          ...
          >
            ...
            <div className="px-5 pb-4 space-y-3">
              {TANDEM_KEYBOARD_SHORTCUTS.map((category) => (
...
export default TandemKeyboardShortcutsModal;
