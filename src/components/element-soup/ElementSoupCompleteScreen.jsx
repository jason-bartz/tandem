...
import { formatTime, getRandomMessage, CONGRATS_MESSAGES } from '@/lib/element-soup.constants';
...
/**
 * ElementSoupCompleteScreen - Shown when puzzle is completed
 */
export function ElementSoupCompleteScreen({
  targetElement,
  targetEmoji,
  elapsedTime,
  movesCount,
...
export default ElementSoupCompleteScreen;
