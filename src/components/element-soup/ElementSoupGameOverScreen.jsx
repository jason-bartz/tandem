...
import { formatTime, getRandomMessage, GAME_OVER_MESSAGES } from '@/lib/element-soup.constants';
...
/**
 * ElementSoupGameOverScreen - Shown when time runs out
 */
export function ElementSoupGameOverScreen({
  targetElement,
  targetEmoji,
  elapsedTime,
  movesCount,
...
export default ElementSoupGameOverScreen;
