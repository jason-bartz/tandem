...
import { REEL_KEYBOARD_SHORTCUTS } from '@/hooks/useReelConnectionsKeyboard';

/**
 * ReelKeyboardShortcutsModal - Overlay showing all keyboard shortcuts for Reel Connections.
 * Triggered by pressing ? or clicking the keyboard hint indicator.
 */
export function ReelKeyboardShortcutsModal({ isOpen, onClose }) {
  const { highContrast, reduceMotion } = useTheme();
  const modalRef = useRef(null);

  // Only handle Escape here; the ? toggle is managed by the keyboard hook
  useEffect(() => {
    if (!isOpen) return;
        ...
        >
          ...
          >
            ...
            <div className="px-5 pb-4 space-y-3">
              {REEL_KEYBOARD_SHORTCUTS.map((category) => (
...
export default ReelKeyboardShortcutsModal;
