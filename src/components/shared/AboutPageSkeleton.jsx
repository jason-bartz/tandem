    ...
    <div className="relative">
      <div className="bg-ghost-white dark:bg-gray-800 rounded-lg overflow-hidden relative z-10">
        ...
        <div className="flex items-center justify-between p-6 pb-4">
          ...
          {/* Title skeleton */}
          <div
            className={`h-6 w-20 bg-gray-200 dark:bg-gray-700 rounded-lg ${!reduceMotion ? 'skeleton-shimmer' : ''}`}
          />
        ...
        <div className="px-8 pb-8">
          ...
          <div className="flex flex-col items-center pt-6 mt-6 border-t border-gray-300 dark:border-gray-600">
            ...
            {/* Name skeleton */}
            <div
              className={`h-5 w-32 bg-gray-200 dark:bg-gray-700 rounded mb-2 ${!reduceMotion ? 'skeleton-shimmer' : ''}`}
            />

            {/* Title skeleton */}
            <div
              className={`h-4 w-48 bg-gray-200 dark:bg-gray-700 rounded ${!reduceMotion ? 'skeleton-shimmer' : ''}`}
            />
          </div>
