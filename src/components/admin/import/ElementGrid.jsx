    ...
    <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 xl:grid-cols-12 gap-2">
      {elements.map((element) => (
        <button
          ...
          className="flex flex-col items-center justify-center p-2 rounded-md bg-bg-card hover:bg-bg-surface hover:scale-105 transition-all duration-200 min-h-[80px]"
        >
