      ...
      <div className="bg-bg-surface rounded-lg p-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 text-center">
          ...
          <div className="p-3 bg-bg-card rounded-lg">
            ...
            <div className="text-sm text-text-secondary font-medium">Unique Themes</div>
          </div>
          <div className="p-3 bg-bg-card rounded-lg">
            <div className="text-2xl font-bold text-text-primary">
              {stats.duplicates}
            </div>
            <div className="text-sm text-text-secondary font-medium">Duplicates</div>
          </div>
          <div className="p-3 bg-bg-card rounded-lg">
                    ...
                    <td className="px-3 sm:px-6 py-2 sm:py-4 text-xs sm:text-sm text-text-primary">
                      <div className="flex flex-wrap gap-1">
                        {puzzle.puzzles.map((p, idx) => (
                          <span
                            key={idx}
                            className="text-[10px] sm:text-xs bg-bg-card px-1.5 sm:px-2 py-0.5 sm:py-1 rounded font-medium"
                          >
                            {p.emoji} {p.answer}
                          </span>
                        ))}
