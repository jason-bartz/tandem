      ...
      <div className="flex justify-between items-start mb-6">
        ...
        {onShowConnections && (
          <button
            ...
            className="px-3 py-2 bg-accent-blue text-white border-[2px] border-black dark:border-white font-bold rounded-lg hover:translate-y-[-2px] transition-transform shadow-[2px_2px_0px_rgba(0,0,0,1)] text-sm flex items-center gap-2 flex-shrink-0"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path
                strokeLinecap="round"
            ...
            <span className="hidden sm:inline">Connection Tracker</span>
