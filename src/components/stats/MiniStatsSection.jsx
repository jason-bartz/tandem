        ...
        <button
          ...
          className={`w-full py-3 px-4 rounded-[20px] border-[3px] font-semibold text-sm transition-all flex items-center justify-center ${
            highContrast
              ...
              : 'bg-yellow-500 dark:bg-yellow-600 text-gray-900 dark:text-gray-900 border-black shadow-[3px_3px_0px_#000] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-[2px_2px_0px_#000]'
          }`}
        >
          View Leaderboard
        </button>
