...
// =====================================================
// DAILY MINI CROSSWORD CONSTANTS
// =====================================================

export const MINI_CONFIG = {
  GRID_SIZE: 5, // 5x5 grid
  START_DATE: process.env.NEXT_PUBLIC_MINI_START_DATE || '2025-11-12',
  THEME_COLOR: '#FFEB3B', // Yellow
  FREE_ARCHIVE_DAYS: 3, // Current day + 3 days back = 4 days total (matches regular Tandem)
...
export const MINI_STORAGE_KEYS = {
  ...
  AUTO_CHECK: 'mini_auto_check',
};

export const MINI_GAME_STATES = {
  NOT_STARTED: 'not_started', // Pre-start screen with START button
  PLAYING: 'playing',
  COMPLETE: 'complete',
  ERROR: 'error',
};
...
export const MINI_DIRECTIONS = {
  ACROSS: 'across',
  DOWN: 'down',
};

export const MINI_CHECK_TYPES = {
  SQUARE: 'square',
  WORD: 'word',
  PUZZLE: 'puzzle',
};

export const MINI_REVEAL_TYPES = {
  SQUARE: 'square',
  WORD: 'word',
  PUZZLE: 'puzzle',
};
