...
import { loadReelStats, DEFAULT_REEL_STATS } from '@/lib/reelStorage';
import { loadAlchemyStats, DEFAULT_ALCHEMY_STATS } from '@/lib/alchemyStorage';
...
export function useUnifiedStats(isOpen) {
  ...
  const [reelStats, setReelStats] = useState(DEFAULT_REEL_STATS);
  const [soupStats, setSoupStats] = useState(DEFAULT_ALCHEMY_STATS);
