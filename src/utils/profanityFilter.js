...
const HOMOGLYPH_MAP = {
  ...
  'Р': 'P', 'С': 'C', 'Т': 'T', 'Х': 'X',
  // Greek lookalikes
  'α': 'a', 'β': 'b', 'γ': 'y', 'ε': 'e', 'ο': 'o', 'ρ': 'p', 'ν': 'v',
  'Α': 'A', 'Β': 'B', 'Ε': 'E', 'Ζ': 'Z', 'Η': 'H', 'Ι': 'I', 'Κ': 'K',
  'Μ': 'M', 'Ν': 'N', 'Ο': 'O', 'Ρ': 'P', 'Τ': 'T', 'Υ': 'Y', 'Χ': 'X',
  // Other Unicode lookalikes
  'ⅰ': 'i', 'ⅱ': 'ii', 'ⅲ': 'iii', 'ⅳ': 'iv', 'ⅴ': 'v',
  'İ': 'I', 'ı': 'i', 'Ł': 'L', 'ł': 'l', 'Ø': 'O', 'ø': 'o',
  '¡': 'i', '£': 'E', '¥': 'Y', '§': 'S',
};
...
const PROFANITY_LIST = [
  ...
  'pussy', 'cunt', 'bastard', 'slut', 'whore', 'fag', 'dyke', 'homo',
  'retard', 'nigger', 'nigga', 'chink', 'spic', 'wetback', 'kike',
  'gook', 'jap', 'wop', 'beaner', 'cracker', 'honkey', 'towelhead',

  // Variations and compound words
  'asshole', 'asswipe', 'dumbass', 'jackass', 'bullshit', 'horseshit',
  'dipshit', 'shithead', 'shitface', 'fuckface', 'motherfucker',
  'fucker', 'fucking', 'fucked', 'dickhead', 'dickface', 'cocksucker',
  'cuntface', 'bitchass', 'douchebag', 'douche', 'prick', 'twat',

  // Sexual/explicit terms
  'penis', 'vagina', 'testicle', 'scrotum', 'anal', 'anus', 'rectum',
  'cumshot', 'cumming', 'orgasm', 'masturbate', 'jerkoff', 'blowjob',
  'handjob', 'footjob', 'rimjob', 'titjob', 'boob', 'tit', 'nipple',
  'porn', 'porno', 'pornography', 'xxx', 'nsfw', 'milf', 'dilf',
  'hentai', 'rape', 'molest', 'pedophile', 'pedo', 'loli', 'shota',

  // Slurs and hate speech
  'nazi', 'hitler', 'genocide', 'kkk', 'terrorist', 'jihadist',
  'supremacist', 'rapist', 'sexist', 'bigot',

  // Drug references (common abuse terms)
  'cocaine', 'heroin', 'meth', 'crack', 'weed', 'marijuana', 'cannabis',
  'mdma', 'ecstasy', 'lsd', 'shrooms', 'xanax', 'oxy', 'fentanyl',
  'drugdealer', 'dealer', 'junkie', 'addict', 'crackhead', 'pothead',
  'stoner', 'tweaker', 'methhead',

  // Violence/threats
  'kill', 'murder', 'rape', 'torture', 'mutilate', 'dismember',
  'assassin', 'hitman', 'terrorist', 'bomber', 'shooter', 'killer',
  'suicide', 'kys', 'killurself', 'killyourself', 'dieslowly',

  // Scam/spam indicators (common fraud patterns)
  'bitcoin', 'crypto', 'winner', 'prize', 'congratulations',
  'cashapp', 'venmo', 'paypal', 'giveaway',

  // Common obfuscation attempts (partial)
  'fuk', 'fck', 'sht', 'btch', 'cnt', 'dck', 'psy', 'fgt', 'ngr', 'nggr',
  'fvck', 'phuck', 'phuk', 'shyt', 'biatch', 'beatch', 'beyotch',

  // Additional inappropriate terms
  'sex', 'sexy', 'sexxx', 'horny', 'nude', 'naked', 'stripper', 'escort',
  'hooker', 'prostitute', 'pimp', 'thot', 'sluttty', 'whoring',
  'hoe', 'hoes', 'booty', 'bootylicious', 'thicc', 'daddy', 'zaddy',
  'buttsex', 'analsex', 'oralsex', 'sexbot', 'sexgod', 'sexytime',

  // Offensive gestures and actions
  'handjob', 'fingerblast', 'fisting', 'sixtynine', '69',

  // Internet slang (inappropriate)
  'af', 'wtf', 'stfu', 'gtfo', 'milf', 'dilf', 'gilf', 'pawg', 'bbw',
  'bbc', 'bwc', 'nsfw', 'r34', 'rule34', 'onlyfans', 'simp', 'incel',

  // Discriminatory terms (additional)
  'tranny', 'shemale', 'ladyboy', 'hermaphrodite', 'midget', 'dwarf',
  'cripple', 'gimp', 'spaz', 'mongoloid', 'autist', 'autistic',

  // Religious offense
  'goddamn', 'godforsaken', 'christkiller', 'islamist', 'infidel',

  // Bodily functions (excessive)
  'poop', 'pee', 'fart', 'burp', 'vomit', 'puke', 'diarrhea', 'turd',
  'semen', 'sperm', 'jizz', 'cum', 'ejaculate', 'menstruation', 'period',

  // Combinations and creative spellings
  'mofo', 'soab', 'pos', 'sob', 'moron', 'idiot', 'imbecile', 'stupid',
  'dumb', 'loser', 'failure', 'worthless', 'pathetic', 'useless',
];
  ...
  for (const profaneWord of PROFANITY_LIST) {
    for (const version of versionsToCheck) {
      ...
      if (shortWordSubstringCheck.includes(profaneWord) && version.includes(profaneWord)) {
        ...
        const legitWordsWithAss = ['assess', 'asset', 'assent', 'bass', 'brass', 'class', 'compass',
                           'crass', 'glass', 'grass', 'harass', 'mass', 'pass', 'trespass',
                           'sussex', 'essex', 'embassy', 'assemble', 'assignment', 'sassafras',
                           'assassin', 'assistance', 'assistant', 'cassette', 'basketball',
                           'passenger', 'massage', 'passage'];
      ...
      // Only for longer profane words (4+ chars) to reduce false positives
...
export function validateUsername(username) {
  ...
  const reservedUsernames = [
    ...
    'official', 'staff', 'team', 'tandem', 'system', 'bot', 'robot',
    'user', 'guest', 'anonymous', 'deleted', 'removed', 'banned',
    'root', 'superuser', 'owner', 'manager',
  ];
