        ...
        <div className="space-y-4">
          <div>
            ...
            <ol className="list-decimal list-inside text-sm mt-2 space-y-1">
              <li><strong>Look at 4 emoji pairs</strong> - Each pair represents a word or phrase</li>
              <li><strong>Guess what they represent</strong> - Type your answer for each pair</li>
              <li><strong>Find the connecting theme</strong> - All 4 answers share a common theme</li>
              <li><strong>Complete within 4 mistakes</strong> - You can make up to 4 incorrect guesses</li>
              <li><strong>Maintain your streak</strong> - Come back daily for new puzzles!</li>
            </ol>
          </div>
          <div>
            <h4 className="font-semibold mb-2">Game Features</h4>
            <ul className="list-disc list-inside text-sm space-y-1">
              <li><strong>Daily Puzzles</strong>: One new puzzle every day at midnight (your local time)</li>
              <li><strong>Puzzle Archive</strong>: Access and play previous puzzles</li>
              <li><strong>Streak Tracking</strong>: Build consecutive days of completed puzzles</li>
              <li><strong>Statistics</strong>: Track your performance over time</li>
              <li><strong>Hint System</strong>: One hint per game reveals character count and first letter</li>
              <li><strong>Dark Mode</strong>: Easy on the eyes for night play</li>
              <li><strong>Sound Effects</strong>: Optional audio feedback</li>
              <li><strong>Offline Play</strong>: Available in iOS native app only</li>
            </ul>
          </div>
        </div>
      )
      ...
      content: (
        <div className="space-y-4">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-sm space-y-1">
              <li><strong>Web-based version</strong> accessible from any browser</li>
          ...
          <div>
            ...
            <p className="text-sm">
              <strong>Coming Soon</strong> to Google Play Store. Currently, Android users can enjoy the PWA version.
              Visit tandemdaily.com on your Android device.
            </p>
          </div>
        </div>
      )
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <p>A: You get one hint per game. It reveals the character count and first letter of a random unsolved answer.</p>
              </div>
              <div>
                <p className="font-medium">Q: What counts as a correct answer?</p>
                <p>A: Answers must match exactly (spelling matters). Answers are not case-sensitive.</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <p className="italic">Solution: Hard refresh the page (Ctrl+F5 on desktop, pull down to refresh on mobile) or force quit and reopen the iOS app.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="italic">Solution: Toggle the moon/sun icon in the top corner. The preference saves automatically.</p>
              </div>
              <div>
                <p className="font-medium">Problem: Can't share results</p>
                <p className="italic">Solution: Ensure your device supports sharing. Try taking a screenshot if the share button isn't working.</p>
              </div>
              <div>
                <p className="font-medium">Problem: Streak reset unexpectedly</p>
                <p className="italic">Solution: Streaks reset if you miss a day. For PWA users, clearing browser data will also reset streaks.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      content: (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm mb-4">We're here to help! If you couldn't find an answer to your question, please reach out:</p>
            <div className="space-y-2 text-sm">
              <p><strong>Email</strong>: jason@goodvibesgames.com</p>
              <p><strong>Response Time</strong>: Within 24-48 hours</p>
              <p><strong>Developer</strong>: Good Vibes Games</p>
              <p><strong>Website</strong>: tandemdaily.com</p>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm">
              We love hearing from our players! Share your feedback, feature requests, bug reports, and puzzle suggestions
              at jason@goodvibesgames.com
            </p>
          </div>
        </div>
      )
        ...
        <div className="w-full max-w-xl mx-auto p-6 relative z-10 my-auto">
          ...
          <div className="bg-white/95 dark:bg-gray-800/95 backdrop-blur-md rounded-3xl shadow-xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-sky-500 to-sky-600 dark:from-sky-600 dark:to-sky-700 p-6 text-white">
              ...
              <p className="mt-2 text-sky-100">Welcome! We're here to help you enjoy your daily puzzle experience.</p>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold mb-3 text-gray-800 dark:text-gray-200">System Requirements</h3>
