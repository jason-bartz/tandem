...
/**
 * Element Soup Page
 * Main route for the Element Soup game
 * Supports: /element-soup (today) or /element-soup?date=YYYY-MM-DD (archive)
 */
export default function ElementSoupPage() {
      ...
      >
        ...
        >
          ...
          <p className="text-text-secondary mb-6">
            Get unlimited access to all past Element Soup puzzles, plus the full archive of Tandem,
          ...
          <div className="space-y-2 mb-8 text-left">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-text-primary">Play all past Element Soup puzzles</p>
            </div>
            <div className="flex items-start gap-3">
              <span className="text-soup-primary text-xl">✓</span>
          ...
          <div className="space-y-3">
            ...
            <button
              onClick={() => router.push('/element-soup')}
              className="
                w-full h-12
                rounded-[16px]
                border-[3px] border-black dark:border-gray-600
  ...
  return <ElementSoupGame initialDate={dateParam} />;
}
