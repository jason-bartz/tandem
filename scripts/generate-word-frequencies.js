...
const veryCommonShortWords = new Set([
  ...
  'ITS', 'MAY', 'NEW', 'NOW', 'OLD', 'SEE', 'TWO', 'WAY', 'WHO', 'WHY',
  'DID', 'SAY', 'SHE', 'TOO', 'USE', 'HER', 'OWN', 'SAW', 'SET', 'PUT',
  'TO', 'OF', 'IN', 'IT', 'IS', 'BE', 'AS', 'AT', 'SO', 'WE',
  'HE', 'BY', 'OR', 'ON', 'DO', 'IF', 'ME', 'MY', 'UP', 'AN',
  'GO', 'NO', 'US', 'AM', 'IT', 'AN', 'AS', 'AT', 'BE', 'BY'
]);

// Common 4-letter words
const veryCommon4Letters = new Set([
  'HAVE', 'THAT', 'WITH', 'THIS', 'WILL', 'YOUR', 'FROM', 'THEY', 'BEEN',
  'CALL', 'COME', 'MADE', 'FIND', 'LONG', 'DOWN', 'MAKE', 'MUCH', 'ONLY',
  'OVER', 'SUCH', 'TAKE', 'THAN', 'THEM', 'WELL', 'WERE', 'WHEN', 'VERY',
  'TIME', 'KNOW', 'WORK', 'BACK', 'HAND', 'GOOD', 'GREAT', 'YEAR', 'LIFE',
  'SAME', 'SOME', 'ALSO', 'THEN', 'MOST', 'BOTH', 'EVEN', 'HELP', 'JUST',
  'LIKE', 'LOOK', 'MORE', 'NEED', 'PART', 'SEEM', 'SHOW', 'TELL', 'TURN',
  'WANT', 'WHAT', 'WORD', 'WORK', 'YEAR', 'ABLE', 'AREA', 'BEST', 'CASE',
  'EACH', 'FACE', 'FACT', 'FEEL', 'FOUR', 'FREE', 'FULL', 'GAVE', 'GIVE',
  'GONE', 'HEAD', 'HEAR', 'HELD', 'HERE', 'HIGH', 'HOME', 'IDEA', 'INTO',
  'KEEP', 'KIND', 'KNEW', 'LAST', 'LATE', 'LEFT', 'LESS', 'LINE', 'LIST',
  'LIVE', 'LOVE', 'MANY', 'MEAN', 'MIND', 'MOVE', 'MUST', 'NAME', 'NEAR',
  'NEXT', 'ONCE', 'OPEN', 'PAID', 'PASS', 'PAST', 'PLAN', 'PLAY', 'READ',
  'REAL', 'REST', 'SAID', 'SEEN', 'SENT', 'SIDE', 'SOON', 'STAY', 'STOP',
  'SURE', 'TALK', 'TOLD', 'TOOK', 'TRUE', 'USED', 'WAIT', 'WALK', 'WEEK',
  'WENT', 'WIDE', 'WISH', 'WOMAN', 'FIVE', 'BODY', 'BOOK', 'BOTH', 'CALL'
]);

// Common 5-letter words
const veryCommon5Letters = new Set([
  'ABOUT', 'AFTER', 'AGAIN', 'BEING', 'BELOW', 'COULD', 'EVERY', 'FIRST',
  'FOUND', 'GOING', 'GREAT', 'GROUP', 'HAPPY', 'HOUSE', 'LARGE', 'LATER',
  'LEAVE', 'LEVEL', 'LIGHT', 'MIGHT', 'NEVER', 'OTHER', 'PARTY', 'PLACE',
  'POINT', 'QUITE', 'RIGHT', 'SHALL', 'SINCE', 'SMALL', 'SOUND', 'STAND',
  'START', 'STATE', 'STILL', 'STUDY', 'THEIR', 'THERE', 'THESE', 'THING',
  'THINK', 'THOSE', 'THREE', 'UNDER', 'UNTIL', 'WATER', 'WHERE', 'WHICH',
  'WHILE', 'WOMAN', 'WORLD', 'WOULD', 'WRITE', 'YEARS', 'YOUNG', 'ABOVE',
  'ALONG', 'AMONG', 'BEGIN', 'BLACK', 'BRING', 'BUILD', 'CARRY', 'CAUSE',
  'CHECK', 'CHILD', 'CLEAR', 'CLOSE', 'OFTEN', 'ORDER', 'PAPER', 'POWER',
  'EARLY', 'HUMAN', 'LOCAL', 'MAJOR', 'MONEY', 'MONTH', 'NORTH', 'PARTY',
  'AREAS', 'ASKED', 'BASED', 'BEGAN', 'BOARD', 'CASES', 'CHANG', 'CLASS',
  'COMES', 'COURT', 'DEATH', 'DOING', 'DRIVE', 'EARLY', 'EIGHT', 'ENTRY',
  'EXTRA', 'FIELD', 'FINAL', 'FORCE', 'FRONT', 'GIVEN', 'GRACE', 'HANDS',
  'HEARD', 'HEART', 'HEAVY', 'IDEAS', 'IMAGE', 'ISSUE', 'ITEMS', 'JONES',
  'KNOWN', 'LANDS', 'LEAST', 'LEGAL', 'LINES', 'LIVED', 'LOOKS', 'MAKES',
  'MARCH', 'MEANS', 'MODEL', 'MOVED', 'MUSIC', 'NAMED', 'NEEDS', 'NIGHT',
  'NOTES', 'OFFER', 'OPENING', 'PEACE', 'PETER', 'PHONE', 'PIECE', 'PLANS',
  'PLAYS', 'PRICE', 'QUITE', 'RANGE', 'REACH', 'READY', 'RIVER', 'ROUND',
  'ROYAL', 'SCALE', 'SCENE', 'SENSE', 'SERVE', 'SEVEN', 'SHALL', 'SHARE',
  'SHORT', 'SHOWN', 'SIDES', 'SITES', 'SIXTH', 'SMITH', 'SOUTH', 'SPACE',
  'SPEAK', 'SPENT', 'SPORT', 'STAFF', 'STAGE', 'STARS', 'STEPS', 'STOCK',
  'STONE', 'STOOD', 'STORE', 'STORY', 'STUFF', 'STYLE', 'TABLE', 'TAKEN',
  'TERMS', 'TEXAS', 'THANK', 'TITLE', 'TODAY', 'TOTAL', 'TOUCH', 'TOWER',
  'TRACK', 'TRADE', 'TRAIN', 'TREAT', 'TRIED', 'TRIES', 'TRUTH', 'TWICE',
  'TYPES', 'UNION', 'UNITS', 'USING', 'VALUE', 'VIDEO', 'VISIT', 'VOICE',
  'WATCH', 'WEEKS', 'WENT', 'WHITE', 'WHOLE', 'WOMEN', 'WORDS', 'WORKS',
  'WORSE', 'WORTH', 'WRONG', 'WROTE'
]);
...
function processWordList(inputPath, outputPath, wordLength) {
  ...
  fs.writeFileSync(
    outputPath,
    JSON.stringify(normalizedFrequencies, null, 2),
    'utf-8'
  );

  console.log(`  ✓ Generated ${normalizedFrequencies.length} words`);
  console.log(`  ✓ Top 10: ${normalizedFrequencies.slice(0, 10).map(w => w.word).join(', ')}`);
